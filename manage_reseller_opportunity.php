...
class ManageResOpportunity
{
    function ListOpportunity()
    {
        ...
        $where=ManageCompanyOpportunity::FilterWhereCondit();
        ...
        $output.='<table width="100%" cellspacing="6" cellpadding="5" class="list_price" border="1" width="100%">
                                        <tbody>';
        $output.='<tr><td colspan="8" class="podd">'.ManageCompanyOpportunity::FilterBy().'</td><td align="right" colspan="2" class="podd">'
        ...
        foreach($result as $rs): 
           ...
           // $imgfls='<a href="javascript:;" onclick="'.$clk.'"><img src="'.plugins_url().'/salesforce_reports/tree/images/'.$simg.'" width="16"></a>';
            ...
            $output.='<td class="podd">'.$currency.$ops->Amount.'</td>';
    ...
    function CreateOpsForm()
    {
        ...
        $selllist=GetResellerSellingList();
        $cpid=$selllist->id;
        $price_flyer=json_decode($selllist->price_flyer);
        //print"<pre>";print_r($price_flyer);print"</pre>";
        ...
        $output='<form name="opsfrm">'.$opshidd.$cust_name.'<table id="TblGrid_jqGrid" class="EditTable" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                        ...
                        <tr rowpos="1" class="FormData" id="tr_OpportunityName">
                            ...
                            <td class="DataTD">&nbsp;<input type="text" id="OpportunityName" name="OpportunityName" role="textbox" class="FormElement ui-widget-content ui-corner-all" value="'.$opportunity->Name.'"></td>
                        </tr>
                        <tr rowpos="2" class="FormData" id="tr_product">
                            <td class="CaptionTD">Product Name</td>
                            <td class="DataTD">&nbsp;<select role="select" multiple="multiple" aria-multiselectable="true" id="product" name="product" size="3" onchange="Selectproduct()" class="FormElement ui-widget-content ui-corner-all">
                            '.$productname.'
                            </select>'.$prod_details.'</td>
                        </tr>
                        <tr rowpos="3" class="FormData" id="tr_Amount">
                            <td class="CaptionTD">Price '.$currency.'</td>
                            <td class="DataTD">&nbsp;<input type="text" readonly="readonly" id="Amount" name="Amount" role="textbox" class="FormElement ui-widget-content ui-corner-all" value="'.$opportunity->Amount.'"></td>
                        </tr>
                        <tr rowpos="4" class="FormData" id="tr_Vertical">
                            <td class="CaptionTD">Vertical</td>
                            <td class="DataTD">&nbsp;<select role="select" id="Vertical" name="Vertical" size="1" class="FormElement ui-widget-content ui-corner-all">
                            '.$vertical.'
                            </select></td>
                        </tr>
                        <tr rowpos="5" class="FormData" id="tr_StageName">
                            <td class="CaptionTD">StageName</td>
                            <td class="DataTD">&nbsp;<select role="select" id="StageName" name="StageName" size="1" class="FormElement ui-widget-content ui-corner-all" onchange="ProbAutoIT()" value="'.$opportunity->StageName.'">
                            '.$stage.'
                            </select></td>
                        </tr>
                        <tr rowpos="6" class="FormData" id="tr_Probability">
                            <td class="CaptionTD">Probability %</td>
                            <td class="DataTD">&nbsp;<input type="text" id="Probability" name="Probability" role="textbox" class="FormElement ui-widget-content ui-corner-all" value="'.$opportunity->Probability.'"></td>
                        </tr>
                '.$showbudgetinfo.'        
                <tr rowpos="3" class="FormData '.$hidedt.'" id="tr_extra">
                    ...
                    <td> Budget </td>
                    <td>
                    <input type="radio" value="1" name="budget" id="budget" onclick="Maxshow()" '.$bd1.'>Yes&nbsp;&nbsp; 
                        <input type="radio" value="0" name="budget" id="budget" onclick="Maxhide()" '.$bd0.'>No&nbsp;&nbsp; 
                            <br>
                                <br>
                    <div id="minmax" '.$mx.'> Min rate 
                        <input type="text" name="minrate" id="minrate" class="FormElement ui-widget-content ui-corner-all" value="'.$minrate.'">
                            <br>
                                <br>Max rate 
                                    <input type="text" name="maxrate" id="maxrate" class="FormElement ui-widget-content ui-corner-all" value="'.$maxrate.'">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" value="1" name="decision" id="decision" onclick="Decisionhide()" '.$dec1.'>Yes&nbsp;&nbsp; 
                                            <input type="radio" value="0" name="decision" id="decision" onclick="Decisionshow()" '.$dec0.'>No&nbsp;&nbsp; 
                                                <br>
                                                    <br>
                                    <div id="decisionshows" '.$whodc.'> Who is the decision maker? 
                                        <input type="text" name="decision_maker" id="decision_maker" class="FormElement ui-widget-content ui-corner-all" value="'.$decision_maker.'">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="radio" value="1" name="needs" id="needs" '.$nee1.'>Yes&nbsp;&nbsp; 
                                                <input type="radio" value="0" name="needs" id="needs" '.$nee0.'>No&nbsp;&nbsp; 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="timeline" id="timeline" class="timeline FormElement ui-widget-content ui-corner-all" value="'.$timeline.'">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                        ...
                        <tr rowpos="7" class="FormData" id="tr_CloseDate">
                            ...
                            <td class="DataTD">&nbsp;<input type="text" id="CloseDate" name="CloseDate" role="textbox" class="timeline FormElement ui-widget-content ui-corner-all" value="'.$opportunity->CloseDate.'"></td>
                        </tr>
                        ...
                        <tr rowpos="1" class="FormData '.$hdcust.'" id="tr_customerinfo"><td class="CaptionTD">Customer Name</td><td class="DataTD">&nbsp; 
                                <input type="text" id="customer_name" name="customer_name" role="textbox" class="FormElement ui-widget-content ui-corner-all" value="'.$cinfo->customer_name.'" '.$cdisb.'></td></tr>                        
                        ...
                        <tr rowpos="1" class="FormData '.$hdcust.'" id="tr_customerinfo"><td class="CaptionTD">Contact Name</td><td class="DataTD">&nbsp; 
                                            <input type="text" id="contact_name" name="contact_name" role="textbox" class="FormElement ui-widget-content ui-corner-all" value="'.$cinfo->contact_name.'"></td></tr>                    
                        <tr rowpos="1" class="FormData '.$hdcust.'" id="tr_customerinfo"><td class="CaptionTD">Contact Email</td><td class="DataTD">&nbsp; 
                                            <input type="text" id="contact_email" name="contact_email" role="textbox" class="FormElement ui-widget-content ui-corner-all" value="'.$cinfo->contact_email.'"></td></tr>            
                        <tr rowpos="1" class="FormData '.$hdcust.'" id="tr_customerinfo"><td class="CaptionTD">Contact Address</td><td class="DataTD">&nbsp; 
                                            <textarea type="text" id="contact_address" name="contact_address" role="textbox" class="FormElement ui-widget-content ui-corner-all">'.base64_decode($cinfo->contact_address).'</textarea></td></tr>
        ...
        $output.='<table border="0" cellspacing="0" cellpadding="0" class="EditTable" id="TblGrid_jqGrid_2">
                ...
                </table><input type="hidden" name="opsdata" id="opsdata" value="1"></form>';
       echo $output;
       exit;
    }
        ...
        <script type="text/javascript">
            function QuoteActivity(opsid)
            {
                ...
                jQuery.ajax({type: "POST",
                    data: "ops_activity=1&opsid="+opsid,
    ...
    function CreateResellerOpportunity()
    {
        ...
        $opsquery="insert into `wp_crm_opportunity` (`user_id`,`opportunity`,`status`,`cpid`,`ops_grp`) values ('".$user_id."','".Json_Format($ops)."','1','".$_POST['cpid']."','2')";
        $wpdb->query($opsquery);
 ...
 * */
    ...
    function GetQuoteForm()
    {
        ...
        if(count($response)>=1):
            ...
            $display.='<input type="hidden" name="calcpr" id="calcpr" value="'.$calcpr.'"><tr rowpos="1" class="FormData" id="tr_OpportunityName"><td class="CaptionTD" valign="top">Discounted price</td><td class="DataTD">'.$currency.'
...
class ResellerOpportunity extends ManageResOpportunity
{
    function display()
    {
